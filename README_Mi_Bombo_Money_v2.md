...
Mi Bombo Money es una aplicación de finanzas personales para iPhone desarrollada con SwiftUI. Permite consultar el patrimonio total, controlar distintas cuentas y revisar ingresos, gastos, presupuestos y objetivos de ahorro desde una única aplicación.

La información se almacena de forma local en el dispositivo. La aplicación no solicita ni guarda credenciales bancarias.
...
La compilación resultante puede ejecutarse en un simulador remoto compatible. Este paquete está preparado para simulador y no puede instalarse directamente en un iPhone físico.

## Importación de movimientos

La aplicación permite importar movimientos desde archivos CSV. Antes de guardar la información se muestra una vista previa para revisar las filas detectadas y descartar posibles duplicados.
...
La eliminación de la aplicación también elimina la información almacenada localmente. Antes de utilizarla como única fuente de control financiero conviene disponer de un sistema de copia de seguridad y restauración verificado.
...
- Importación específica para distintos formatos bancarios.
- Pruebas en diferentes modelos de iPhone.
